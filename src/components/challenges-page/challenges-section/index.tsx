    ...
    <section className="flex w-full flex-row flex-wrap gap-5 bg-gradient-to-tr from-primary to-secondary p-5 sm:p-8 md:px-16 lg:px-32 lg:py-16 xl:px-48 xl:py-20">
        ...
        <Card className="flex flex-1 flex-col justify-between gap-10 p-12">
            <div className="flex max-w-xl flex-col gap-5">
                ...
                <Text variant="paragraph">
                    Publish your first smart contract in minutes with Solana
                    Playground!
                </Text>
                <Text variant="paragraph" className="font text-xl text-primary">
                    {' '}
        ...
        <Card className="flex flex-1 flex-col justify-between gap-10 p-12">
            <div className="flex max-w-xl flex-col gap-5">
                ...
                <Text variant="paragraph">
                    Learn how to use the new transaction format with Versioned
                    Transactions.
                </Text>
                <Text variant="paragraph" className="font text-xl text-primary">
                    {' '}
        ...
        <Card className="flex flex-1 flex-col justify-between gap-10 p-12">
            <div className="flex max-w-xl flex-col gap-5">
                ...
                <Text variant="paragraph">
                    Dive into the Solana programming model with this overview on
                    Accounts.
                </Text>
                <Text variant="paragraph" className="font text-xl text-primary">
                    {' '}
